...
<body>
    ...
    <section id="home" class="hero">
        <div class="hero-container">
            <div class="hero-content">
                ...
                <p class="hero-subtitle">Materi terstruktur, latihan langsung di browser, dan project nyata. Ga cuma nonton. Lu langsung ngoding.</p>
                <div class="hero-cta">
            ...
            <div class="roadmap-container">
                <div class="roadmap-level">
                    ...
                    <ul class="level-items">
                        ...
                        <li class="badge-item"><span class="badge">Latihan</span> <span class="badge">Mini Project</span></li>
                    </ul>
                </div>
                <div class="roadmap-level">
                    <div class="level-header">
    ...
    <section class="demo-editor">
        <div class="container">
            ...
            <p class="demo-caption"><i class="fas fa-mouse-pointer"></i> Kode bisa diedit, klik Run untuk lihat hasilnya</p>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="testimonial-grid">
                <div class="testimonial-card">
                    <div class="quote">"</div>
                    <p class="testimonial-text">Akhirnya ngerti Java tanpa pusing. Materinya step-by-step, langsung praktek.</p>
                ...
                <div class="testimonial-card">
                    <div class="quote">"</div>
                    <p class="testimonial-text">Ga nyangka bisa bikin project Python cuma dalam 2 bulan. Recommended banget!</p>
                    <div class="testimonial-author">
                ...
                <div class="testimonial-card">
                    <div class="quote">"</div>
                    <p class="testimonial-text">Roadmap-nya jelas banget. Ga kayak tutorial random di YouTube yang lompat-lompat.</p>
                    <div class="testimonial-author">
    ...
    <section class="cta-section">
        <div class="container">
            <h2 class="cta-title">Berhenti Scroll Tutorial.<br><span class="gradient-text">Mulai Ngoding Beneran.</span></h2>
        ...
        <div class="container">
            <div class="footer-grid">
                <div class="footer-logo">
                    <span class="logo-gradient">MasterCode</span>
                    <p>Belajar coding dari nol sampai siap kerja dengan materi terstruktur.</p>
                </div>
                ...
                <div class="footer-links">
                    <h4>Kontak</h4>
                    <ul>
                        <li><i class="fas fa-envelope"></i> hello@mastercode.com</li>
            ...
            <div class="footer-bottom">
                <p>&copy; 2024 MasterCode. All rights reserved.</p>
                <p class="footer-note">Made with <i class="fas fa-heart" style="color: #ff4d4d;"></i> for developers</p>
            </div>
        </div>
    </footer>
